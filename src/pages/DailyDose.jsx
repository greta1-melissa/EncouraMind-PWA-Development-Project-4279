        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex items-center justify-center mb-4">
              <SafeIcon icon={FiSun} className="w-8 h-8 text-secondary mr-2" />
            ...
            <div className="flex justify-center mt-4">
              <button
                ...
                className="flex items-center space-x-2 bg-primary text-gray-800 px-4 py-2 rounded-full hover:bg-primary-600 transition-colors"
              >
                <SafeIcon
                  icon={FiRefreshCw}
          ...
          <motion.div
            ...
            className="bg-primary text-gray-800 rounded-2xl p-8 mb-8 shadow-soft"
          >
            <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {moods.map((mood) => (
                ...
                >
                  <SafeIcon
                    icon={mood.icon}
                    className={`w-8 h-8 mb-2 ${mood.color}`}
                  />
          ...
          <motion.div
            ...
            className="bg-secondary-50 dark:bg-gray-800 rounded-2xl p-8 shadow-soft"
          >
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white font-heading">
                Story of Strength
